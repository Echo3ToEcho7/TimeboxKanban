...
module.exports = function(grunt) {
  ...
  grunt.registerTask('deploy', ['build', 'rallydeploy:rally1']);
  ...
  return grunt.initConfig({
    ...
    concat: {
      src: {
        src: [
          'src/ColumnCardFieldPicker.js',
          'src/CardAgeSettingsField.js',
          'src/ColumnSettingsField.js',
          'src/Column.js',
          'src/Settings.js',
          'src/KanbanApp.js'
        ],
    ...
    rallydeploy: {
      options: {
        ...
        projectOid: 3298099842,
        deployFile: "deploy.json",
        credentialsFile: "credentials.json",
        tab: "myhome",
        pageName: "Timeboxed Kanban",
        shared: 'off'
      },
      rally1: {
      }
